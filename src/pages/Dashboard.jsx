  ...
  return (
    <Container className="py-4">
      ...
      <Row className="g-4">
        ...
        <Col md={4}><Card style={{ ...cardStyle, background: 'linear-gradient(135deg, #00c6ff, #0072ff)' }}><Card.Body className="d-flex justify-content-between align-items-center"><div><Card.Title>Internal Users</Card.Title><Card.Text className="fs-3 fw-semibold">15</Card.Text></div><FaUserPlus size={36} /></Card.Body></Card></Col>
